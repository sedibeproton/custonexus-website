...
export const metadata: Metadata = {
  ...
  description: "Submit a detailed CustoNexus enquiry, request a quote or arrange a callback for healthcare technology, medical equipment, professional services or partnerships.",
          ...
          <Container>
            <div className="grid gap-10 xl:grid-cols-[0.64fr_1.36fr] xl:items-start">
              <aside className="xl:sticky xl:top-32">
                ...
                <p className="mt-5 text-lg leading-8 text-slate-600">The guided form adapts to your service. You can request a quote, ask for a callback or share an early-stage idea.</p>
