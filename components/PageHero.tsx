...
export default function PageHero({ eyebrow, title, subtitle }: PageHeroProps) {
  return (
    <section className="relative isolate overflow-hidden bg-[#071a3d] pb-20 pt-36 text-white sm:pb-24 sm:pt-44 lg:pb-28">
      ...
      <Container><FadeIn><div className="max-w-5xl">
        ...
        <h1 className="mt-6 text-4xl font-semibold leading-[1.04] tracking-[-0.045em] sm:text-6xl lg:text-7xl">{title}</h1>
        <p className="mt-6 max-w-3xl border-l border-blue-400/50 pl-5 text-base leading-8 text-blue-100 sm:pl-6 sm:text-xl sm:leading-9">{subtitle}</p>
