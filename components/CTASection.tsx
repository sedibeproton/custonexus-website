...
export default function CTASection({
  ...
  return (
    <Section spacing="md" className="bg-[#f7f9fc] text-white">
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-[#071a3d] px-6 py-12 text-center shadow-[0_30px_90px_rgba(7,26,61,.22)] sm:rounded-[2.5rem] sm:px-12 sm:py-16">
