...
export default function EnquiryForm() {
  ...
  async function submit() {
    ...
    const detailKeys = ["websiteType", "pageCount", "audience", "features", "contentStatus", "appType", "platform", "users", "integrations", "equipmentRequestType", "productNames", "specifications", "quantity", "deliveryLocation", "supportType", "challenge", "partnershipType", "proposal", "requirements", "timeline", "budget"];
    ...
    <div className="overflow-hidden rounded-[2rem] border border-blue-100 bg-white shadow-[0_28px_80px_rgba(15,48,105,.12)]">
      ...
      <div className="p-5 sm:p-8 lg:p-10">
        {step === 1 && <div><h2 className="text-2xl font-semibold text-blue-950 sm:text-3xl">What would you like help with?</h2><p className="mt-3 text-slate-600">Your answers determine the next questions.</p>
          ...
          {form.service === "healthcare-technology" && <fieldset className="mt-7"><legend className={labelClass}>What are you planning?</legend><div className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">{[["website","Website"],["app","App"],["portal","Portal or dashboard"],["hosting","Hosting, maintenance or email"],["integration","Integration or other"]].map(([value,label]) => <Choice key={value} name="projectType" value={value} label={label} selected={form.projectType === value} onChange={() => set("projectType", value)} />)}</div></fieldset>}
        </div>}
