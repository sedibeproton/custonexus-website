...
const features = [
  { icon: CalendarDays, label: "Bookings & availability" },
  { icon: MessageSquareText, label: "Enquiries & WhatsApp" },
  { icon: LayoutDashboard, label: "Mobile-friendly design" },
  { icon: ShieldCheck, label: "Hosting & ongoing care" },
] as const;
      ...
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
          <div>
            ...
            <Link href="/services/business-websites" className="group mt-8 inline-flex items-center gap-3 rounded-2xl bg-white px-6 py-4 font-bold text-blue-950 transition hover:-translate-y-0.5 hover:bg-blue-50">
              Explore website services <ArrowRight size={18} aria-hidden className="transition group-hover:translate-x-1" />
            </Link>
          </div>
            ...
            <div className="relative overflow-hidden rounded-[1.75rem] border border-white/15 bg-[#071a3d]/90 shadow-[0_35px_100px_rgba(0,0,0,.45)] backdrop-blur-xl sm:rounded-[2.25rem]">
              ...
              <div className="relative grid min-h-[420px] gap-6 p-5 sm:min-h-[500px] sm:p-8 md:grid-cols-[0.9fr_1.1fr] md:items-center">
                ...
                <div>
                  ...
                  <h3 className="mt-6 text-3xl font-semibold leading-tight tracking-[-0.04em] sm:text-4xl">Clear on every screen. Useful at every step.</h3>
                  ...
                  <div className="mt-7 flex items-center gap-3 text-sm font-bold text-emerald-300"><CheckCircle2 size={18} aria-hidden /> Custom-built for new projects</div>
                </div>
